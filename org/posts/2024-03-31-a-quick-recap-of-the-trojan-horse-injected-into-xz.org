...
Obfuscation techniques and other automatically detectable issues that went unnoticed to permit this injection to happen, which can make one feel both worse /and/ better at the same time.
